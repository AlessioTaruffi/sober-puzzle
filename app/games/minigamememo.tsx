...
const GameScreen = () => {
    ...
    const handleCardPress = (index: number) => {
        ...
        // 1. Calcola come sarà lo stato aggiornato
            ...
            setTimeout(() => { 
                Alert.alert('Che sola', 'Hai toppato', [
                    { text: 'Riprova', onPress: () => {
                        setRound(1);
                        setForceReset((prev) => prev + 1);}, //forza il reset dello stato 
                        //evita che il gioco di blocchi se uno é scarso e fallisce al primo round
        ...
        // 4. Controlla se tutte le carte giuste sono state selezionate
